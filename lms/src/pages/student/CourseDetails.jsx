...
import {getText} from "eslint-plugin-react/lib/util/eslint.js";
...
const CourseDetails = () => {
    ...
    const {allCourses, calculateRating, calculateChapterTime, calculateNumberOfLectures, calculateCourseDuration, backendUrl, userData, getToken} = useContext(LmsContext)
    ...
    const enrollCourse = async () => {
        try {
            if (!userData) {
                return toast.warn('Авторизируйтесь для записи на курс!')
            }
            if (isAlreadyEnrolled) {
                return toast.warn('Вы уже записаны на этот курс!')
            }
        ...
        <>
            <div
                ...
                <div className='max-w-xl z-10 text-gray-500 mt-20'>
                    ...
                    <p className='text-sm'>Курс by <span className='text-blue-600 underline'>{courseData.educator.name}</span></p>
