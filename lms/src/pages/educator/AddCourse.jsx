...
const AddCourse = () => {
    const {backendUrl, getToken} = useContext(LmsContext)
    ...
    const handleSubmit = async (event) => {
        try {
            ...
            if (!image) {
                ...
                toast.warn('Изображение не выбрано!')
                return;
            }
                ...
                <div className='flex items-center justify-between flex-wrap'>
                    ...
                    <div className='flex md:flex-row flex-col items-center gap-3'>
                        ...
                        <label htmlFor="thumbnailImage" className='flex items-center gap-3'>
                            <img src={assets.file_upload_icon} className='bg-blue-500  p-3   rounded' alt=""/>
                            <input  type='file' id='thumbnailImage' className=''
